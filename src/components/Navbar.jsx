...
const Navbar = () => {
  ...
  return (
    <nav className="shadow-lg w-full fixed top-0 lef-0 z-50">
      <div className="md:flex items-center justify-between bg-[#E9EDDF]  py-[1rem] md:px-[6rem] px-[3rem]">
        <a href="/">
        ...
        <div
          className="text-orange-600 absolute right-8 top-4 text-3xl cursor-pointer md:hidden"
        ...
        <ul
          className={` md:flex md:items-center md:pb-0 pb-6 absolute md:static md:z-auto z-[-1] left-0 w-full
            md:w-auto md:pl-0 pl-12 md:bg-transparent bg-white transition-all ease-in duration-500 md:border-b-0 border-b-2  ${
              open
                ? "top-10 opacity-100 transition duration-1000 ease-out"
                : "top-[-490px]"
            }`}
        >
          {paths.map((path) => (
          ...
          <li className="md:ml-7 md:my-0 my-1">
            <a href="\Login">
